...
<body>
    ...
    <div>   
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\GemachDB.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Dresses]" ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [Dresses] WHERE [id_dress] = @original_id_dress AND [size] = @original_size AND (([length] = @original_length) OR ([length] IS NULL AND @original_length IS NULL)) AND (([color] = @original_color) OR ([color] IS NULL AND @original_color IS NULL)) AND (([image_path] = @original_image_path) OR ([image_path] IS NULL AND @original_image_path IS NULL)) AND (([style] = @original_style) OR ([style] IS NULL AND @original_style IS NULL)) AND (([additional_text] = @original_additional_text) OR ([additional_text] IS NULL AND @original_additional_text IS NULL))" InsertCommand="INSERT INTO [Dresses] ([size], [length], [color], [image_path], [style], [additional_text]) VALUES (@size, @length, @color, @image_path, @style, @additional_text)" OldValuesParameterFormatString="original_{0}" UpdateCommand="UPDATE [Dresses] SET [size] = @size, [length] = @length, [color] = @color, [image_path] = @image_path, [style] = @style, [additional_text] = @additional_text WHERE [id_dress] = @original_id_dress AND [size] = @original_size AND (([length] = @original_length) OR ([length] IS NULL AND @original_length IS NULL)) AND (([color] = @original_color) OR ([color] IS NULL AND @original_color IS NULL)) AND (([image_path] = @original_image_path) OR ([image_path] IS NULL AND @original_image_path IS NULL)) AND (([style] = @original_style) OR ([style] IS NULL AND @original_style IS NULL)) AND (([additional_text] = @original_additional_text) OR ([additional_text] IS NULL AND @original_additional_text IS NULL))">
            <DeleteParameters>
